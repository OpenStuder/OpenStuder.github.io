...
var SIBluetoothTestConnection = /** @class */ (function () {
    function SIBluetoothTestConnection(hook, docsifyWM) {
        var _this = this;
        this.onCopyButtonClicked = function (event) {
            var value = event.target.parentElement.parentElement.querySelector('code').innerHTML.split('<br>').join('\n');
        ...
        hook.doneEach(function () {
            if (docsifyWM.route.path.indexOf('/bluetooth') == 0) {
                ...
                for (var i = 0; i < requests.length; ++i) {
                    ...
                    editButton.onclick = _this.onCopyButtonClicked;
